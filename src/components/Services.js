  ...
  return (
    <div name='service'>
      <div className="relative  m-8 py-5">
          <h1 className="font-[montserrat] text-3xl font-bold leading-8 tracking-wide dark:text-white uppercase w-[695px] h-[43px]">services provided by</h1>
          <h1 className="font-[montserrat] text-4xl font-bold leadeing-9 tracking-widest dark:text-[#FF1700] w-[695px] h-[56px] block">MATRIX LABS</h1>  
